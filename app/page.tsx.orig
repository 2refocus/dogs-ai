  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      if (canProceed) {
        ...
        // NEW: accept either `output` or `urls[0]`
        const url: string | null =
          (typeof out.output === "string" ? out.output : null) ||
          (Array.isArray(out.urls) && out.urls.length > 0 ? out.urls[0] : null);
      ...
      <section className="card grid gap-4">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-xs opacity-70">
            We’ll tailor the styles to your chosen subject. <b>Auto</b> merges both
            sets and neutralizes species words in the prompt.
          </p>
        </div>
        ...
        {(showPanel || result) && (
          <div className="grid gap-4">
            ...
            <div className="grid gap-3 sm:grid-cols-[160px_1fr] items-start">
              <div className="grid gap-2">
                {preview ? (
                  <img className="preview" src={preview} alt="original upload" />
                ) : (
              ...
              <div className="grid gap-2">
                ...
                <div className="flex gap-2 flex-wrap">
                  <button className="btn-primary" onClick={downloadNow} disabled={!result}>
                    Download
                  </button>
                  <a
